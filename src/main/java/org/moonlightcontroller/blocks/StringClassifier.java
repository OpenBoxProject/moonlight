...
public class StringClassifier extends ProcessingBlock implements IClassifierProcessingBlock{
	...
	public StringClassifier(String id, List<String> pattern, Priority priority) {
		super(id);
		this.pattern = pattern;
		this.priority = priority;
	}
	
	public StringClassifier(String id, List<String> pattern, boolean payload_only, Priority priority) {
		super(id);
		this.pattern = pattern;
	...
	protected ProcessingBlock spawn(String id) {
		return new StringClassifier(id, pattern, payload_only, priority);
	}
